...
(function (context, factory) {
	...
	function unbindAxis(up, down, left, right, callback) {
		function clear() {
			if(typeof clearUp === 'function') { clearUp(); }
			if(typeof clearDown === 'function') { clearDown(); }
			if(typeof clearLeft === 'function') { clearLeft(); }
		...
		//up
		var clearUp = unbindKey(up);

		//down
		var clearDown = unbindKey(down);

		//left
		var clearLeft = unbindKey(left);

		//right
		var clearRight = unbindKey(right);
